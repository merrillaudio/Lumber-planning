...
# ---- Streamlit App ----\
\
st.title("\uc0\u55358 \u56986  Wood Cutting Optimizer (Imperial)")\
\
...
\
if st.button("\uc0\u55358 \u56800  Optimize Cut Plan"):\
    cut_plan, leftovers = fit_pieces_to_boards(boards_df, required_df, kerf)\
\
    st.subheader("\uc0\u55357 \u56523  Cut Plan Preview")\
    for board in cut_plan:\
...
\
    ...
    st.download_button("\uc0\u55357 \u56516  Download PDF", data=pdf_bytes, file_name="cut_plan.pdf", mime="application/pdf")\
\
    csv_string = generate_csv(cut_plan)\
    st.download_button("\uc0\u55357 \u56516  Download CSV", data=csv_string, file_name="cut_plan.csv", mime="text/csv")\
\
    # Leftovers\
    if leftovers:\
        st.warning("\uc0\u9888 \u65039  Some pieces couldn't be placed:")\
